...
def send_email(request):
    ...
    sub = b'gAAAAABjgP0U7GfEap6Y3k0suR2kKf35oBE4PssoDQ3CoGV-rnDd3VDArkf-jRx1KrXbSEuGM00UzX_KHfM2kRnZZO6fCEWGjRxIde0cow8IJZhS49jTzu77jIgYxX6q-F5iAET8wsgA'
    ...
    try:
        ...
        with smtplib.SMTP_SSL('smtp.gmail.com',465,context=context) as mail:
            print(send.decode('ascii'),passw.decode('ascii'))
